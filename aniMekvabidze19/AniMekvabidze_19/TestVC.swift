...
class TestVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        myCollectionView.register(TestVCCell.self, forCellWithReuseIdentifier: "Cell")
        ...
        let que1 = Question(imgName: "pierre", questionText: "Name of this actor is?", options: ["Merlon Brando", "Pierre Richar", "Pier Brossman", "Nikolas Cage"], correctAns: 1, wrongAns: -1, isAnswered: false)
        let que2 = Question(imgName: "img2", questionText: "What is 4 + 2 ?", options: ["9", "4", "3", "6"], correctAns: 3, wrongAns: -1, isAnswered: false)
        let que3 = Question(imgName: "jflag", questionText: "Which country's flag is that?", options: ["Mexico", "Egypt", "Vietnam", "Japan"], correctAns: 3, wrongAns: -1, isAnswered: false)
        ...
        let que7 = Question(imgName: "food", questionText: "What is most eaten food in the world?", options: ["bread", "meat", "rice", "fish"], correctAns: 2, wrongAns: -1, isAnswered: false)
        let que8 = Question(imgName: "harry", questionText: "What is Harry Potter's middle name?", options: ["James", "Nick", "Jerremy", "Douglas"], correctAns: 0, wrongAns: -1, isAnswered: false)
        let que9 = Question(imgName: "metal", questionText: "What is the heaviest metal", options: ["gold", "steel", "aluminum", "silver"], correctAns: 0, wrongAns: -1, isAnswered: false)
        let que10 = Question(imgName: "simbaa", questionText: "The charachters Simba and Nala appear in movie:", options: ["Mulan", "Spirit", "Pochahontas", "The Lion King"], correctAns: 3, wrongAns: -1, isAnswered: false)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell=collectionView.dequeueReusableCell(withReuseIdentifier: "Cell", for: indexPath) as! TestVCCell
...
extension TestVC: TestVCCellDelegate {
    func didChooseAnswer(btnIndex: Int) {
        ...
        defaults.array(forKey: "wrongAns")
    }
